...
class Lab6 extends GLJPanel implements GLEventListener  {
    ...
    //ustalanie materia³ów
            gl2.glMaterialfv (GL2.GL_FRONT, GL2.GL_AMBIENT_AND_DIFFUSE, materials[2], 1);
            ...
            gl2.glMaterialfv(GL2.GL_FRONT, GL2.GL_AMBIENT_AND_DIFFUSE, materials[2],3);
